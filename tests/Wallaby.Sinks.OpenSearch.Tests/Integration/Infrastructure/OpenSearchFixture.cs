...
namespace Wallaby.Sinks.OpenSearch.Tests.Integration.Infrastructure;

/// <summary>A shared single-node OpenSearch container (security disabled) for sink integration tests.</summary>
public sealed class OpenSearchFixture : IAsyncInitializer, IAsyncDisposable
{
    private readonly IContainer _container = new ContainerBuilder("opensearchproject/opensearch:3.2.0")
