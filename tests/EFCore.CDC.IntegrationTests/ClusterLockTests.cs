...
public class ClusterLockTests(PostgresFixture pg)
{
    ...
    public async Task Only_one_holder_acquires_the_same_key()
    {
        ...
        var node1 = new PostgresAdvisoryLock(pg.ConnectionString);
        var node2 = new PostgresAdvisoryLock(pg.ConnectionString);
    ...
    {
        var locker = new PostgresAdvisoryLock(pg.ConnectionString);
