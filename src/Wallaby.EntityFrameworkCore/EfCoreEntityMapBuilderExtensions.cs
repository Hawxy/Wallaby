...
public static class EfCoreEntityMapBuilderExtensions
{
        ...
        where TEntity : class
    {
        ...
        return map.UsingTransformInvoker(_ => new EfCoreTransformInvoker<TEntity>(transform));
    }
    ...
    public static EntityMapBuilder<TEntity> UsingTransform<TEntity, TTransform>(this EntityMapBuilder<TEntity> map)
        ...
        => map.UsingTransformInvoker(sp =>
            new EfCoreTransformInvoker<TEntity>(ActivatorUtilities.GetServiceOrCreateInstance<TTransform>(sp)));
        ...
        where TEntity : class
    {
        ...
        return map.UsingTransformInvoker(_ => new EfCoreTransformInvoker<TEntity>(new DelegateTransform<TEntity>(handler)));
    }
}
