...
internal static class ColumnListPlanner
{
    ...
    /// <summary>Returns the effective spec (possibly demoted to whole-table) and a warning when demoted.</summary>
    public static (PublicationTableSpec Effective, string? Warning) Plan(
