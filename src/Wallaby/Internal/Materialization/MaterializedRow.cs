...
/// <summary>The result of materializing a <see cref="Model.RawChange"/> against the EF Core model.</summary>
/// <param name="Entity">The materialized CLR entity (may be partial for deletes).</param>
/// <param name="Record">Current (or, for deletes, last-known) values keyed by EF property name.</param>
...
internal sealed record MaterializedRow(
    object? Entity,
