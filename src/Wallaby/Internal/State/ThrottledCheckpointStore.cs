...
/// seconds-stale checkpoint only widens a detected slot-loss gap, whose repair is a full re-backfill
/// either way. The caller is the single-threaded pipeline loop.
/// </summary>
