...
/// written as a length-prefixed <see cref="SpillCodec"/> record. Zero source-DB load, but needs a writable
/// path. Opt in via <c>SpillToDisk</c>; the database backend is the default.
/// </summary>
