...
/// <summary>Configuration for a <see cref="ElasticsearchSink"/>.</summary>
public sealed class ElasticsearchSinkOptions
{
    /// <summary>Elasticsearch base URL, e.g. <c>https://localhost:9200</c>.</summary>
    ...
    /// <summary>
    /// Base64 API key (as issued by Kibana or Elastic Cloud). Mutually exclusive with
